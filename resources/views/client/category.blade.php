                            ...
                            <div class="col-6 col-sm-4">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h3 class="product-title"> <a href="{{ route('detailProduct', $item->id) }}">{{ $item->name }}</a> </h3>
                                        ...
                                        <div class="price-box">
                                            <span
                                                class="old-price">{{ number_format($item->price + '3000000', 0, ',', '.') }}đ</span>
                                            <span
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="{{ route('detailProduct', $item->id) }}"
                                                class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>XEM
                                                    CHI TIẾT</span></a>
